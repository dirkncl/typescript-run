import { TooltipContent, TooltipOptions } from '../types/index.ts';
...
class Tooltip {
  ...
  private async loadStyles(): void {
    ...
    const styles = await get('../styles/main.css')
    //console.log(styles)
...
export { Tooltip, TooltipContent, TooltipOptions };
