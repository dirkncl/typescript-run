...
export function assert(truth: boolean) {
  if (!truth) {
...
export function stableSort<T>(array: T[], compare: (left: T, right: T) => number) {
...
export function nextMultipleOf(size: number, align: number): number {
