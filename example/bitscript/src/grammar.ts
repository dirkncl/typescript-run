import { spanRange, ParserContext, Pratt } from './parser.ts'
import { syntaxErrorDuplicateModifier } from './diagnostics.ts'
import {
  AST,
  Module,
  Identifier,
...
import { SymbolModifier } from './symbols.ts'
import { TypeModifier } from './types.ts'
...
export function parse(log: Log, tokens: Token[]): Module {
