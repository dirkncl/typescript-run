...
import { Type, SpecialType, WrappedType } from './types.ts'
import {
  AST,
  Module,
  Identifier,
...
export class OutputJS implements StatementVisitor<Object>, DeclarationVisitor<Object>, ExpressionVisitor<Object> {
