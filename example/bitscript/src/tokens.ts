import { syntaxErrorExtraData } from './diagnostics.ts'
import { Marker,  SourceRange } from './common.ts'
...
export function tokenize(log: Log, source: Source): Token[] {
...
export function prepareTokens(tokens: Token[]): Token[] {
