...
import { TypeModifier, SpecialType, FunctionType, ObjectType, WrappedType } from './types.ts'
import {
  AST,
  Module,
  Identifier,
...
export class OutputCPP implements StatementVisitor<Object>, DeclarationVisitor<Object>, ExpressionVisitor<Object> {
