...
import { BinaryLayout } from './binarylayout.ts'
import { assert, flatten }  from './common.ts'
import { NativeTypes } from './nativetypes.ts'
import { TypeLogic } from './typelogic.ts'
import { Type, FunctionType, ObjectType, WrappedType } from './types.ts'
import {
  AST,
  Module,
  Identifier,
...
export class OutputAsmJS implements StatementVisitor<any>, DeclarationVisitor<any>, ExpressionVisitor<AsmJSPair> {
