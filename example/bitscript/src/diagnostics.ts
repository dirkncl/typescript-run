...
export { 
  ...
  syntaxErrorBadEscapeSequence,
  syntaxErrorExtraData,
  syntaxErrorDuplicateModifier,
  semanticErrorDuplicateSymbol,
  semanticErrorIncompatibleTypes,
  semanticErrorCircularType,
  semanticErrorUnknownSymbol,
  semanticErrorUnexpectedExpression,
  semanticErrorPointerModifierConflict,
  semanticErrorInvalidPointerModifier,
  semanticErrorUnexpectedStatement,
  semanticErrorInvalidNew,
  semanticErrorInvalidCall,
  semanticErrorArgumentCount,
  semanticErrorRValueToRawPointer,
  semanticErrorNoMembers,
  semanticErrorUnknownMemberSymbol,
  semanticErrorNoUnaryOperator,
  semanticErrorNoBinaryOperator,
  semanticErrorExpectedReturnValue,
  semanticErrorBadStorage,
  semanticErrorBadBaseType,
  semanticErrorNoCommonType,
  semanticErrorUnexpectedModifier,
  semanticErrorModifierOverMissingBase,
  semanticErrorModifierMissingOver,
  semanticErrorOverrideNotFunctions,
  semanticErrorOverrideDifferentTypes,
  semanticErrorAbstractNew,
  semanticErrorCannotParameterize,
  semanticErrorParameterCount,
  semanticErrorUnparameterizedExpression,
  semanticErrorParameterizedExpression,
  semanticErrorBadParameter,
  semanticErrorMoveAndUse,
  semanticErrorBadMove,
  semanticErrorExpectedMove,
  semanticErrorBadVariableType
}
