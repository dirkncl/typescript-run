...
import { spanRange } from './parser.ts'
import { Symbol, Scope, SymbolModifier, ForEachSymbol } from './symbols.ts'
import { NativeTypes } from './nativetypes.ts'
import { TypeLogic } from './typelogic.ts'
import { TypeModifier, Type, SpecialType, FunctionType, ObjectType, TypeParameter, Substitution, WrappedType } from './types.ts'
import {
  AST,
  Module,
  Identifier,
...
export class Resolver implements StatementVisitor<void>, DeclarationVisitor<void>, ExpressionVisitor<void> {
